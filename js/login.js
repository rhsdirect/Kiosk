...
$(document).ready(function () {
  ...
  let url = window.location.href.split("/")[(window.location.href.includes("127.0.0.1") ? 4 : 5)].split(".")[0];
  let blacklist = [
		"index", 
		"staff_login",
	];

  console.log(url, sessionStorage.getItem("loggedIn"));
  console.log(url.includes(blacklist));
  ...
  let sfTimer = setTimeout(() => {
    if (window.location.href.split("/")[(window.location.href.includes("127.0.0.1") ? 4 : 5)] == "student_profile.html") {
